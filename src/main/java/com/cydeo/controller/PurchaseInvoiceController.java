...
public class PurchaseInvoiceController {
    ...
    @GetMapping("list")
    public String listAllPurchaseInvoices(Model model) throws Exception {
        model.addAttribute("invoices", invoiceService.getAllInvoicesOfCompany(InvoiceType.PURCHASE));
    ...
    @GetMapping("update/{invoiceId}")
    public String editPurchaseInvoice(@PathVariable("invoiceId") Long invoiceId, Model model) {
    ...
    @PostMapping("/update/{invoiceId}")
    public String updatePurchaseInvoice(@PathVariable("invoiceId") Long invoiceId, @ModelAttribute("invoice")  InvoiceDto invoiceDto, Model model) {
        model.addAttribute("vendors", clientVendorService.getAllClientVendorsOfCompany(ClientVendorType.VENDOR));
        invoiceService.update(invoiceId, invoiceDto);
        return "redirect:/purchaseInvoices/list";
    }
