 ...
 * <p>
 * <p>
 * {@code @Entity:} Entities in JPA are nothing but POJOs representing data that can be persisted to the database
 * An entity represents a table stored in a database
 * Every instance of an entity represents a row in the table
 * Entity classes must not be declared final
 * {@code @Id:} Each JPA entity must have a primary key which uniquely identifies it. @Id annotation defines the primary key
 *
