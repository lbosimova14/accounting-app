-- We can initialize the database using Spring’s built-in schema.sql and data.sql
-- this is verbose code, we store in schema.sql file, and it will create new table called employees,
...
('2022-09-11 00:00', 2, 'false', '2022-09-11 00:00', 2, '2022-09-11', 'P-003', 'PURCHASE', 'AWAITING_APPROVAL', 4, 2),
